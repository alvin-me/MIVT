...
namespace {
  ...
  */
  std::string resolveLineNumber(int number, const std::vector<tgt::ShaderObject::LineInfo>& lineTracker) {
    ...
    result << tgt::FileSystem::fileName(lineTracker[found].filename_) << ":"
...
namespace tgt {
  ...
  const std::string ShaderPreprocessor::loggerCat_("common.ShaderPreprocessor");
  ...
  const string ShaderObject::loggerCat_("common.ShaderObject");
  ...
  const string Shader::loggerCat_("common.Shader");
  ...
  void Shader::setFragmentHeader(const std::string& customHeader) {
    for (ShaderObjects::iterator iter = objects_.begin(); iter != objects_.end(); ++iter) {
      if ((*iter)->getType() == ShaderObject::FRAGMENT_SHADER) {
        (*iter)->setHeader(customHeader);
      }
    }
  }
  ...
  // Vectors
  bool Shader::setUniform(const string& name, const vec2& value) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
    setUniform(l, value);
  ...
  bool Shader::setUniform(const string& name, vec2* vectors, GLsizei count) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
  ...
  bool Shader::setUniform(const string& name, const vec3& value) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
    setUniform(l, value);
  ...
  bool Shader::setUniform(const string& name, vec3* vectors, GLsizei count) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
  ...
  bool Shader::setUniform(const string& name, const vec4& value) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
    setUniform(l, value);
  ...
  bool Shader::setUniform(const string& name, vec4* vectors, GLsizei count) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
  ...
  bool Shader::setUniform(const string& name, const mat2& value, bool transpose) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
  ...
  bool Shader::setUniform(const string& name, const mat3& value, bool transpose) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
    setUniform(l, value, transpose);
  ...
  bool Shader::setUniform(const string& name, const mat4& value, bool transpose) {
    GLint l = getUniformLocation(name);
    if (l == -1)
      return false;
    setUniform(l, value, transpose);
  ...
  // Vectors
  void Shader::setUniform(GLint l, const vec2& value) {
    glUniform2fv(l, 1, glm::value_ptr(value));
  }

  void Shader::setUniform(GLint l, const vec3& value) {
    glUniform3fv(l, 1, glm::value_ptr(value));
  }

  void Shader::setUniform(GLint l, const vec4& value) {
    glUniform4fv(l, 1, glm::value_ptr(value));
  }
  ...
  void Shader::setUniform(GLint l, const mat2& value, bool transpose) {
    glUniformMatrix2fv(l, 1, transpose, glm::value_ptr(value));
  }

  void Shader::setUniform(GLint l, const mat3& value, bool transpose) {
    glUniformMatrix3fv(l, 1, transpose, glm::value_ptr(value));
  }

  void Shader::setUniform(GLint l, const mat4& value, bool transpose) {
    glUniformMatrix4fv(l, 1, transpose, glm::value_ptr(value));
  }
  ...
  // For vectors
  void Shader::setAttribute(GLint index, const vec2& v) {
    glVertexAttrib2fv(index, glm::value_ptr(v));
  }

  void Shader::setAttribute(GLint index, const vec3& v) {
    glVertexAttrib3fv(index, glm::value_ptr(v));
  }

  void Shader::setAttribute(GLint index, const vec4& v) {
    glVertexAttrib4fv(index, glm::value_ptr(v));
  }

  void Shader::setAttribute(GLint index, const ivec4& v) {
    glVertexAttrib4iv(index, glm::value_ptr(v));
  }
  ...
  const string ShaderManager::loggerCat_("common.ShaderManager");
